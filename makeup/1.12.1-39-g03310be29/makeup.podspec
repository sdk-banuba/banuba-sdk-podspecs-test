Pod::Spec.new do |s|
    ...
    s.summary       = "Banuba SDK makeup module"
    ...
    s.platform      = :ios, '13.0'
    s.source        = { :http => "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-39-g03310be29/makeup.zip" }
    ...
    s.vendored_frameworks = "makeup.xcframework"
    s.requires_arc = true
end
